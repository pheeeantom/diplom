...
var attr_generated = [];
var attr_no_string = [0, 9, 15, 21, 27];
for (var i = 0; i < allAttrs.length; i++) {
  ...
  attr_generated.push({
    "type": allAttrs[i],
    "message0": allAttrs[i].split(/_/)[2] + " of " + allAttrs[i].split(/_/)[1] + " \" %1 \"",
    "args0": [
      {
        "type": "field_input",
    ...
    "previousStatement": allAttrs[i].split(/_/)[1] === 'location' ? attr_location : allAttrs[i].split(/_/)[1] === 'set' ? attr_set : attr_block,
    "nextStatement": allAttrs[i].split(/_/)[1] === 'location' ? attr_location : allAttrs[i].split(/_/)[1] === 'set' ? attr_set : attr_block
    //"output": "attr"
  });
}
...
},
{
  ...
  "message1": "base %1",
  "args1": [
    {"type": "input_value", "name": "BASE", "check": "text"}
  ],
  "message2": "attrs %1",
  "args2": [
    {"type": "input_statement", "name": "ATTRS", "check": attr_location}
  ],
  "message3": "%1",
  "args3": [
...
},
{
  ...
  "previousStatement": attr_block,
  "nextStatement": attr_block
  //"output": "attr"
},
...attr_generated,
{
